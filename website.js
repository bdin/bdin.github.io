...
function valid() {
	...
	if (document.getElementById("current-p").innerHTML.replace(/(<([^>]+)>)/ig,"").toLowerCase() == "bio") {
		...
		document.getElementById("typewriter").removeAttribute("id");
		var input = document.getElementById("input");
		input.insertAdjacentHTML('afterend','<div id="input"><span class="directory">benjamindin</span><span id="typewriter" class="text" data-text="My name is Benjamin Din, and I\'m a journalism student at Northwestern University. I\'m currently an intern on the graphics and design teams at <a href=&quot;https://www.washingtonpost.com/people/benjamin-din&quot; target=&quot;_blank&quot;>The Washington Post</a>. On campus, I\'m a student fellow at the <a href=&quot;http://knightlab.northwestern.edu&quot; target=&quot;_blank&quot;>Knight Lab</a>, where I explore the intersection of journalism and technology. I also report, write and code at <a href=&quot;https://dailynorthwestern.com/staff/?writer=Benjamin%20Din&quot; target=&quot;_blank&quot;>The Daily Northwestern</a>. Past stints: interactive intern at the <a href=&quot;http://sfchronicle.com/special-reports&quot; target=&quot;_blank&quot;>San Francisco Chronicle</a> and reporting intern at <a href=&quot;http://www.iol.co.za/search?q=%22benjamin+din%22&quot; target=&quot;_blank&quot;>The Star</a> in Johannesburg. "></span></div>');
		input.removeAttribute("id");
		var input = document.getElementById("input");
		var text = document.getElementById('typewriter').dataset.text;  
		typeWriter(text, 0);
